...
def call() {
	pipeline {
		...
		environment {
			...
			LAYER_PROD = 'arn:aws:lambda:eu-west-1:530328198985:layer:a2i-lambda-demand-forecast-layer:23'
			LAYER_STAGE = 'arn:aws:lambda:eu-west-1:403475184785:layer:a2i-lambda-demand-forecast-layer:15'
			MEMORY = '512'
