...
deleteForecastExports(){
  ...
  aws forecast list-forecast-export-jobs --profile $profile | grep -e '"ForecastExportJobArn":' | cut -d ':' -f2- | cut -d ',' -f1 | cut -d '.' -f1 | cut -d '"' -f2 > tmpListForecastExports.txt
...
deleteForecast(){
  ...
  aws forecast list-forecasts --profile $profile | grep -e '"ForecastArn":' | cut -d ':' -f2- | cut -d ',' -f1 | cut -d '.' -f1 | cut -d '"' -f2 > tmpListForecast.txt
...
deletePredictor(){
  ...
  aws forecast list-predictors --profile $profile | grep -e '"PredictorArn":' | cut -d ':' -f2- | cut -d ',' -f1 | cut -d '.' -f1 | cut -d '"' -f2 > tmpListPredictor.txt
...
deleteDatasetImport(){
  ...
  aws forecast list-dataset-import-jobs --profile $profile | grep -e '"DatasetImportJobArn":' | cut -d ':' -f2- | cut -d ',' -f1 | cut -d '.' -f1 | cut -d '"' -f2 > tmpListDatasetImport.txt
...
deleteDataset(){
  ...
  aws forecast list-datasets --profile $profile | grep -e '"DatasetArn":' | cut -d ':' -f2- | cut -d ',' -f1 | cut -d '.' -f1 | cut -d '"' -f2 > tmpListDataset.txt
...
deleteDatasetGroup(){
  echo 'Listing all eligible datasets which can be deleted'
  aws forecast list-dataset-groups --profile $profile | grep -e '"DatasetGroupArn":' | cut -d ':' -f2- | cut -d ',' -f1 | cut -d '.' -f1 | cut -d '"' -f2 > tmpListDatasetGroup.txt
