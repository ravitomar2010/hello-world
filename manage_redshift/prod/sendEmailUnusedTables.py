...
profile=""
queryfile='tmp_unused_tables.csv'
...
subject=profile+" | Suspected redshift junk/ unused tables"
headerForHTML='<html> <body> <p>Hi All</p> <p>Please find below list of junk/ unused tables from redshift for '+profile+' account. Please reach out to DevOps If we can delete any of these.</p>'
