...
output "infra_subnet_arns" {
  description = "List of ARNs of infra subnets"
  value       = aws_subnet.infra.*.arn
}
...
output "infra_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of infra subnets in an IPv6 enabled VPC"
  value       = aws_subnet.infra.*.ipv6_cidr_block
}
