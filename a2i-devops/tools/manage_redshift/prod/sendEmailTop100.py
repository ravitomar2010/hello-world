...
profile=""
queryfile='tmp_query_results.csv'
...
subject=profile+" | Redshift top 100 tables as per size"
headerForHTML='<html> <body> <p>Hi All</p> <p>Please find below list of top 100 tables from redshift sorted as per size for '+profile+' account. </p>'
